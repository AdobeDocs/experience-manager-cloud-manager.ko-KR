...
[!UICONTROL Cloud Manager] 2018.9.0 릴리스에는 [!UICONTROL Cloud Manager]의 CI/CD 파이프라인을 다른 시스템과 통합하기 위한 이벤트 등 Adobe I/O 기반 API에 대한 지원이 추가되었습니다. 또한 반응으로 UI 레이어의 재작성을 시작합니다.
