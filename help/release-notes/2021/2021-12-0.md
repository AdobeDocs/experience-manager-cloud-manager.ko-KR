...
description: 다음은 Cloud Manager 릴리스 2021.12.0의 릴리스 정보입니다.
...
다음 섹션에서는 의 일반 릴리스 정보에 대해 간략히 소개합니다. [!UICONTROL Cloud Manager] 릴리스 2021.12.0.
...
의 릴리스 날짜 [!UICONTROL Cloud Manager] 릴리스 2021.12.0은 2021년 12월 16일입니다. 다음 릴리스는 2022년 1월 일에 예정되어 있습니다.
