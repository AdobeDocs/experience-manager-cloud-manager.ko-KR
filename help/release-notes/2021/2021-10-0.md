...
* Cloud Service과의 일관성을 위해 이제 기존 배포 파이프라인이 UI에서 &#39;전체 스택&#39; 파이프라인으로 참조되고 레이블이 지정됩니다.
...
* 내부 시스템에서 읽은 데이터를 올바르게 입력하면 Adobe CSE(고객 성공 엔지니어)에서 제공한 관련 없는 데이터가 Cloud Manager에 제대로 반영되지 않을 수 있습니다.
