...
* Adobe Developer 콘솔에서 통합을 만들 수 있는 권한을 특정 사용자에게 부여할 수 있는 Admin Console에서 새 API 개발자 역할을 사용할 수 있습니다. 자세한 내용은 [개발자 관리](https://helpx.adobe.com/kr/enterprise/using/manage-developers.html)를 참조하세요.
* Maven Archetype이 버전 16으로 업데이트되었습니다.
* Maven의 버전이 버전 3.6.0으로 업데이트되었습니다.

## 버그 수정 {#bug-fixes}

* 타겟 환경이 Azure에서 호스팅되었을 때 파이프라인이 실행되지 않는 경우도 있습니다.
* 환경 순서가 일관되지 않았습니다.
