---
title: Cloud Manager 2026.2.0 릴리스 노트
description: Adobe Managed Services의 Cloud Manager 2026.2.0 릴리스에 대해 알아봅니다.
...
# Adobe Managed Services의 Cloud Manager 2026.2.0 릴리스 노트 {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Adobe Managed Services의 [!UICONTROL Cloud Manager] 2026.2.0 릴리스에 대해 알아봅니다.
...
[!UICONTROL Cloud Manager] 2026.2.0의 릴리스 날짜는 2026년 2월 5일 목요일입니다.

<!-- There are no significant new features or bug fixes in the May Cloud Manager release. -->

다음 예정 릴리스는 2026년 3월 5일 목요일입니다.
...
* **안정성, 성능 및 안정성 향상**
  ...
  이 릴리스에는 Cloud Manager의 안정성, 성능 및 안정성을 개선하는 최적화 및 유지 관리 업데이트가 포함되어 있습니다.


## Beta 프로그램 {#beta-program}

일반 릴리스 전에 예정된 기능에 미리 액세스하려면 [!UICONTROL Cloud Manager]의 베타 프로그램에 참여하십시오.

현재 제공되는 기회는 다음과 같습니다.

### Experience Hub 확장성 및 사용자 정의 {#exp-hub-extensibility}

[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)은(는) 조직의 필요에 맞게 사용자 지정된 AEM의 중앙 액세스 지점입니다. Adobe에서 기존 AEM UI 확장을 활성화하는 데 도움이 될 수 있도록 Experience Hub에 기존 UI 확장에 대한 세부 정보를 제공합니다.
...
참여하려면 Adobe OrgID와 만들려는 사용자 지정에 대한 간단한 설명을 사용하여 [beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com)에 전자 메일을 보내십시오.

### 모듈 캐싱을 통한 빌드 속도 향상 {#quick-build-cm-pipelines}

새 빌드 모델은 모듈 수준 캐싱을 사용하여 전체 저장소가 아닌 변경된 모듈만 컴파일하여 빌드 시간을 줄입니다. 코드 품질, 전체 스택 및 스테이지 전용 파이프라인에 적용됩니다.
...
참여하려면 Adobe OrgID와 프로그램 ID로 [beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com)에 전자 메일을 보내십시오.

<!-- You can deactivate incremental builds at the pipeline level by setting the property `CM_BUILD_DISABLE_MODULE_CACHING` to `true` (effective during the `BUILD` step). For how to add pipeline variables, see [Pipeline variables](/help/getting-started/build-environment.md#pipeline-variables). -->

## 버그 수정 {#bug-fixes}

AMS 릴리스의 2026년 2월 Cloud Manager에는 중요한 버그 수정이 없습니다.
