...
[Experience Hub](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/experience-hub/experience-hub)은(는) 조직의 필요에 맞게 사용자 지정된 AEM의 중앙 액세스 지점입니다. Adobe에서 기존 AEM UI 확장을 활성화하는 데 도움이 될 수 있도록 Experience Hub에 기존 UI 확장에 대한 세부 정보를 제공합니다.
