...
source-git-commit: 21d24467fda221742e610123103c1fcc2ba318f8
workflow-type: tm+mt
...
일반 릴리스 이전에 예정된 기능에 독점적으로 액세스하려면 Cloud Manager의 베타 프로그램에 참여할 수 있습니다.
...
새 빌드 모델은 모듈 수준 캐싱을 사용하여 전체 저장소가 아닌 변경된 모듈만 컴파일하므로 빌드 시간이 줄어듭니다. 코드 품질 및 전체 스택 파이프라인에 적용됩니다.
