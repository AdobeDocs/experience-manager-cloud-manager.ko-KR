...
[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)은(는) 조직의 요구 사항에 맞게 사용자 지정된 AEM 액세스 포인트입니다. 기존 AEM UI 확장에 대한 세부 정보를 Adobe에 제공하면 Experience Hub에서 효율적으로 사용할 수 있습니다.
