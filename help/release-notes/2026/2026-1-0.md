...
source-git-commit: e876e08866ea720c734f84654f2525e26651e840
workflow-type: tm+mt
...
일반 릴리스 이전에 예정된 기능에 독점적으로 액세스하려면 Cloud Manager의 Beta 프로그램에 참여하십시오.

현재 제공되는 기회는 다음과 같습니다.

### Experience Hub 확장성 및 사용자 정의 {#exp-hub-extensibility}

[Experience Hub](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/experience-hub/experience-hub)은(는) 조직의 요구 사항에 맞게 사용자 지정된 AEM 액세스 포인트입니다. 기존 AEM UI 확장에 대한 세부 정보를 Adobe에 제공하면 Experience Hub에서 효율적으로 사용할 수 있습니다.
...
Beta에 참여하시겠습니까? Adobe OrgID 및 만들고자 하는 사용자 정의에 대한 간단한 설명을 첨부한 이메일을 [beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com)으로 보내 주시기 바랍니다.
...
참여하시겠습니까? Adobe OrgID 및 프로그램 ID를 첨부한 이메일을 [beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com)으로 보내 주시기 바랍니다.
