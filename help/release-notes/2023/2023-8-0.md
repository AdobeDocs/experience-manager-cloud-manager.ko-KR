...
# Cloud Manager 2023.8.0의 릴리스 정보 {#release-notes}
...
* Cloud Manager UI의 오류 메시지의 이해도와 노출을 개선했습니다.

## 버그 수정 {#bug-fixes}

* [콘텐츠 복사본](/help/using/content-copy.md)이(가) 끊기는 드문 경우가 해결되었습니다.
...
* 더 이상 실행 중인 것처럼 보이는 중단된 파이프라인이 사용자에게 발생하지 않습니다.
