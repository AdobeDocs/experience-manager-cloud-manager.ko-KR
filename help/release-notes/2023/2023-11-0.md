...
description: Cloud Manager 2023.11.0 릴리스 정보입니다.
...
# Cloud Manager 2023.11.0 릴리스 노트 {#release-notes}
...
[!UICONTROL Cloud Manager] 2023.11.0의 릴리스 날짜는 2023년 11월 14일입니다. 다음 릴리스는 2023년 12월 7일 금요일에 예정되어 있습니다.
...
* [파이프라인 실행 페이지](/help/using/managing-pipelines.md#activity-window)에서 완료된 단계에 이제 기간이 표시됩니다
...
이 새로운 기능을 테스트하고 피드백을 공유하려면 Adobe ID과 연결된 전자 메일 주소에서 `Grp-CloudManager_ams_custompermissions@adobe.com`을(를) 보내 전자 메일을 보내세요.
