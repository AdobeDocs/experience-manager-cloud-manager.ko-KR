...
이제 [AEM Experience Hub](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/experience-hub/experience-hub)의 UI 확장 지원이 활성화되었으므로 개발자는 Adobe App Builder을 사용하여 빌드된 사용자 지정 기능 및 위젯으로 인터페이스를 확장할 수 있습니다.
