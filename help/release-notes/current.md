...
* **AEM Experience Hub에서 사용자 인터페이스 확장성 지원.**
  ...
  이제 [AEM Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)의 사용자 인터페이스 확장 지원이 활성화되어 개발자가 Adobe App Builder을 사용하여 빌드된 사용자 지정 기능 및 위젯으로 인터페이스를 확장할 수 있습니다.
