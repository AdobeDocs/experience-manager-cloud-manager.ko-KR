...
* 이전 버전과 호환되지 않으며 업그레이드 후 실패할 수 있는 AEM 6.x 기능 또는 API를 감지합니다.
...
패턴 감지기는 모든 환경에서 실행할 수 있습니다. 하지만 검색 속도를 높이고 중요한 인스턴스에 성능에 영향을 주지 않도록 하기 위해 Cloud Manager은 작성자 인스턴스의 스테이징 환경에서 이를 실행합니다.
...
1. 마법사가 작업 상태를 알려 줍니다. 평가 보고서가 생성되는 동안 **진행 중** 또는 **완료됨**&#x200B;을 참고하십시오.

1. 보고서가 생성되면 **[!UICONTROL 보고서 다운로드]**&#x200B;를 클릭하여 사본을 저장할 수 있습니다.

   ![보고서 생성됨](/help/assets/Evaluation-1.png)

Cloud Manager의 현재 제품 업데이트 마법사는 **평가** 단계만 지원합니다. 나머지 네 단계, 즉 **교정**, **실행**, **유효성 검사** 및 **완료**&#x200B;가 곧 제공됩니다.
