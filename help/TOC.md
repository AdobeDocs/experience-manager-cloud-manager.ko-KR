...
user-guide-description: Cloud Manager를 사용하여 클라우드에서 AMS용 Adobe Experience Manager을 자체 관리하는 방법을 알아봅니다.
...
+ 개요 {#overview}
   ...
   + [보안 및 개인 정보](overview/security-and-privacy.md)
...
+ 사용 {#using}
   ...
   + [맞춤형 코드 품질 규칙](using/custom-code-quality-rules.md)
+ 코드 관리 {#managing-code}
   + [Maven 프로젝트 버전 처리](managing-code/maven-project-version.md)
   + [저장소](managing-code/repositories.md)
   + [Git과 통합](managing-code/git-integration.md)
   + [여러 Git 리포지토리 작업](managing-code/multiple-git-repos.md)
