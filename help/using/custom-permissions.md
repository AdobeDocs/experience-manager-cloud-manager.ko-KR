...
Admin Console을 사용하는 방법에 대한 자세한 내용은 [기업 사용자의 제품 프로필 관리](https://helpx.adobe.com/kr/enterprise/using/manage-product-profiles.html) 문서의 **제품 프로필에 사용자 및 사용자 그룹 추가**&#x200B;를 참조하십시오.
...
* Cloud Manager에서 만든 프로그램, 환경, 파이프라인 등의 리소스는 권한 구성을 위해 Admin Console에 표시되는 데 2분이 걸릴 수 있습니다.
