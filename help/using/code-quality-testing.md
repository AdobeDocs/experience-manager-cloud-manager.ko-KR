...
코드 품질 테스트 결과는 이 테이블에 요약된 등급으로 제공됩니다.
...
>[!NOTE]
>
>자세한 내용은 [SonarQube의 지표 정의](https://docs.sonarsource.com/sonarqube-server/latest/user-guide/code-metrics/metrics-definition/)를 참조하십시오.
