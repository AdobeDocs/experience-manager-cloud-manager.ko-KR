...
>[!TIP]
>
>[이 링크를 사용하여 전체 규칙 목록을 다운로드할 수 있습니다](/help/assets/CodeQuality-rules-latest-AMS.xlsx).
...
### 긍정 오류(false positive) 처리 {#dealing-with-false-positives}
...
##### 선택한 페이지 세트 간 트래픽 분포 {#distribution-of-traffic}
...
#### 테스트를 위한 Assets 배포 {#distribution-of-assets}
