...
Cloud Manager는 이제 Java 8과 Java 11을 모두 사용하여 고객 프로젝트 작성을 지원합니다. 기본적으로 프로젝트는 Java 8을 사용하여 빌드됩니다. 프로젝트에서 Java 11을 사용하려는 고객은 [Apache Maven Toolchain Plugin](https://maven.apache.org/plugins/maven-toolchains-plugin/)을 사용할 수 있습니다.
