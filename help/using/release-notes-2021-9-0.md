...
다음 섹션에서는 다음에 대한 일반 릴리스 노트를 간략하게 설명합니다 [!UICONTROL Cloud Manager] 릴리스 2021.9.0.
...
에 대한 릴리스 날짜 [!UICONTROL Cloud Manager] 버전 2021.9.0은 2021년 9월 9일입니다.
...
* 프로그램 카드에서 바로 을 클릭하면 이제 Cloud Manager의 **개요** 페이지.
