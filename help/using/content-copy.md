...
1. 대상 환경에서 제외 경로를 삭제하거나 유지하도록 선택할 수 있습니다. 확인란 선택 `Do not delete exclude paths from destination` 콘텐츠 세트에 지정된 제외 경로를 유지하려면, 확인란을 선택 취소하면 제외 경로가 타겟 환경에서 삭제됩니다.
...
* 컨텐츠 세트당 최대 50개의 경로를 지정할 수 있습니다. 제외된 경로에는 제한이 없습니다.
