...
>[!NOTE]
>
>이 기능을 사용하려면 CSE(Customer Success Engineer)에게 문의하십시오.
...
* 교차 프로그램 및 지역 간 컨텐츠 복사는 불가능합니다.
* 클라우드 데이터 저장소 기반 토폴로지에 대한 콘텐츠 복사는 소스 및 대상 환경이 동일한 클라우드 공급자에 있는 경우에만 수행할 수 있습니다.
...
* 일단 시작된 컨텐츠 복사본은 일시 중지하거나 취소할 수 없습니다.
