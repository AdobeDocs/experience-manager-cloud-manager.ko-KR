...
1. 소스에서 대상 환경으로 복사되는 경로의 버전 기록을 복사하도록 선택할 수 있습니다. 확인란 선택 `Copy Versions` 모든 버전 기록을 복사하려는 경우.
...
* 클라우드 데이터 저장소 기반 토폴로지에 대한 콘텐츠 복사는 소스 및 대상 환경이 동일한 클라우드 공급자 및 지역에 있는 경우에만 수행할 수 있습니다.
