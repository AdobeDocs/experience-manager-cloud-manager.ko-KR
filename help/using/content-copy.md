...
1. 화면 오른쪽 상단의 **콘텐츠 세트 추가** 단추를 클릭합니다.
...
1. 마법사의 콘텐츠 경로 탭에서 콘텐츠 세트에 포함할 변경 가능한 **콘텐츠 경로**&#x200B;를 지정합니다.
   ...
   1. **경로 추가** 단추를 클릭하여 콘텐츠 세트에 경로를 추가합니다.
   1. 필요에 따라 **경로 추가** 단추를 다시 클릭합니다.
...
1. 필요에 따라 지정한 경로를 변경할 수 있습니다.
   ...
   1. 제외된 하위 경로 옆에 있는 X 를 클릭하여 삭제합니다.
   1. **편집** 및 **삭제** 옵션을 표시하려면 경로 옆에 있는 줄임표 버튼을 클릭하십시오.
