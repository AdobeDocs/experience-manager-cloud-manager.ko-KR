...
[!UICONTROL Cloud Manager]에서 프로덕션 파이프라인이 시작되고(성공 또는 실패), 프로덕션 배포를 시작할 때, **Go-Live 승인** 및 **예약됨** 단계에 도달하면 알림을 보냅니다. 이러한 알림은 [!UICONTROL Experience Cloud] 알림 시스템을 통해 전송됩니다.
