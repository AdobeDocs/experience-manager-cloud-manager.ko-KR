...
암호를 취소하려면 [이 요청에 대한 지원 티켓을 만드십시오](https://experienceleague.adobe.com/?support-solution=Experience+Manager&support-tab=home#support). 티켓은 우선 순위가 높게 지정되며 일반적으로 하루 이내에 해결됩니다.
