...
Cloud Manager는 Adobe에서 관리하는 저장소(**Adobe 저장소**)와 사용자 관리 저장소(**비공개 저장소**)를 모두 지원합니다. 필수 필드는 추가하기 위해 선택한 저장소 유형에 따라 다릅니다.

[Cloud Manager에서 Adobe 저장소 추가](adobe-repositories.md)를 참조하십시오.
[Cloud Manager에서 비공개 저장소 추가](private-repositories.md)를 참조하십시오.
