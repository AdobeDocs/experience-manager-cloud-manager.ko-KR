...
**저장소** 페이지에서는 선택한 프로그램에 Adobe 관리 저장소를 추가할 수 있습니다.
...
1. 각 텍스트 필드에 다음 사항을 입력합니다.
   ...
   * **저장소 이름** - 새 저장소의 설명 이름입니다.
   * **저장소 URL 미리 보기** - 저장소 인프라가 Adobe에서 이미 구성, 통합 및 관리되고 있으므로 URL 경로를 입력하거나 기존 경로를 편집할 필요가 없습니다.
