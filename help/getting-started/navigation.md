...
1. 시작하기 링크를 통해 [온보딩 설명서 여정](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/overview)에 액세스하여 Cloud Manager를 시작하고 실행할 수 있습니다.
