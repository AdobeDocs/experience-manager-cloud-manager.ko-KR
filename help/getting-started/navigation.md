...
>[!TIP]
>
>문서를 참조하십시오. [프로그램 및 프로그램 유형](/help/getting-started/program-setup.md) 프로그램에 대한 자세한 내용.
...
1. 알림 아이콘에 현재 할당된 미완료 알림 수가 배지로 표시됩니다. [알림입니다.](/help/using/notifications.md)
...
1. 시작 링크를 통해 다음에 액세스할 수 있습니다. [온보딩 설명서 여정](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/overview) Cloud Manager를 시작하고 운영해 보십시오.
   * 온보딩 여정은 AMS용 Cloud Service이 아닌 AEMas a Cloud Service 용으로 설계되었지만 많은 개념이 동일합니다.
...
* 의 수 [배포](/help/using/code-deployment.md)
* 의 수 [코드 품질 문제](/help/using/code-quality-testing.md) 식별됨
* 빌드 수
...
* 프로그램 이미지(구성된 경우)
* 프로그램 이름
* 서비스 유형: **Experience Manager 클라우드** 대상 [AEM as a Cloud Service 프로그램](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/home) 또는 **Experience Manager** ams 프로그램용
* [프로그램 유형](/help/getting-started/program-setup.md): 샌드박스 또는 프로덕션
* 상태
* 구성된 솔루션
* 생성일
...
* 특정 페이지로 이동 [환경](/help/using/managing-environments.md) / 프로그램
...
다음 **라이선스** 탭에서는 라이선스 대시보드에 빠르게 액세스할 수 있습니다.
...
* [활동](/help/using/managing-pipelines.md#activity) - 프로그램의 파이프라인 실행 내역
...
* [보고서](/help/using/monitoring-environments.md#system-monitoring-overview) - SLA 데이터와 같은 지표
...
콜 투 액션 섹션은 프로그램의 상태에 따라 유용한 정보를 제공합니다. 새 프로그램의 경우 다음 단계 및 Go-Live 날짜 알림 메시지가 제공될 수 있습니다. [프로그램을 만드는 동안 설정됩니다.](/help/getting-started/program-setup.md)

라이브 프로그램의 경우, 세부 정보 및 새 배포 시작에 대한 링크가 포함된 마지막 배포의 상태입니다.

![클릭 유도 문안](assets/info-banner.png)
...
문서를 참조하십시오. [환경 관리](/help/using/managing-environments.md) 환경 관리 방법에 대한 자세한 내용을 참조하십시오.
...
문서를 참조하십시오. [파이프라인 관리](/help/using/managing-pipelines.md) 파이프라인 관리 방법에 대한 자세한 내용을 참조하십시오.
