...
Cloud Manager가 기본 제공 [프로젝트 생성 마법사](/help/getting-started/using-the-wizard.md)를 사용하여 생성한 프로젝트는 자동으로 올바른 Maven 프로젝트 구조가 생성됩니다. Adobe Managed Services(AMS)를 처음 사용하는 경우 권장되는 경로입니다.
...
1. 각 대상 Dispatcher의 키-값 쌍에 필요한 변수를 정의하고 각 인스턴스의 [변수](https://experienceleague.adobe.com/docs/experience-manager-learn/ams/dispatcher/variables.html?lang=ko#variables-files-(.vars)) 폴더에 추가하십시오.
