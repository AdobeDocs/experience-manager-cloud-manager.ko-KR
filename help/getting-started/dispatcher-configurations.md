...
1. 각 대상 Dispatcher의 키-값 쌍에 필요한 변수를 정의하고 각 인스턴스의 [variables](https://experienceleague.adobe.com/ko/docs/experience-manager-learn/ams/dispatcher/variables) 폴더에 추가하십시오.
